...
class _TuitionScreenState extends State<TuitionScreen> {
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Icon(Icons.school_outlined, color: diuGray, size: 58),
            ...
            ElevatedButton.icon(
              onPressed: () {
                _showOfferTuitionMessage(context);
              },

              icon: const Icon(Icons.add_rounded),

              label: const Text('Offer Tuition'),
  ...
  void _showOfferTuitionMessage(BuildContext context) {
    Navigator.push(
      context,
